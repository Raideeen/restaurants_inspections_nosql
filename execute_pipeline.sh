...
(cd csv && tar -czvf ../inspections_restaurant.tar.gz *)

echo -e "\n[INFO] Copying tar.gz file and script to docker..."
docker cp inspections_restaurant.tar.gz $docker_name:/home
docker cp create_import_table.cql $docker_name:/home

echo -e "\n[INFO] Extracting tar.gz file in docker..."
docker exec -it $docker_name mkdir /home/inspections_restaurant
docker exec -it $docker_name tar -xzvf /home/inspections_restaurant.tar.gz -C /home/inspections_restaurant
